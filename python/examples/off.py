...
def rainbowCycle(strip, CYCLECOUNTER, wait_ms=20, iterations=50, bling=True):
...
def breathingRainbow(strip, wait_ms=200, iterations=1):
	"""Draw rainbow that fades across all pixels at once."""
	brightness = 0
	direction = 1
	step = 4
...
if __name__ == '__main__':
	...
	while True:
		...
		# Rainbow animations.
		# breathingRainbow(strip, 200, 10)
		# rainbowCycle(strip, CYCLECOUNTER, 20, 1, True)
